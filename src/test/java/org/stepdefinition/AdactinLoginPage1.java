...
fillTextBox(a.getEmailText(), "Saranya1701");}

@When("To send the valaid password")
public void to_send_the_valaid_password() {
    fillTextBox(a.getPasswordText(), "Saranya@17");
}
...
public void enter_first_name() {
    ...
    fillTextBox(a4.getFirstName(), "saranya");
}

@When("Enter last name")
public void enter_last_name() {
    a4=new AdactinBookHotelPojo4();
    fillTextBox(a4.getLastName(), "S");
...
public void enter_billing_address() {
	a4=new AdactinBookHotelPojo4();
    fillTextBox(a4.getAddress(), "No.1284,balaji nagar,chennai 600100");
}
